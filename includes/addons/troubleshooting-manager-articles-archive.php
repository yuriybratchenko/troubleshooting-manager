...
class Troubleshooting_Manager_Articles_Archive extends Troubleshooting_Manager_Base {

	public function get_name() {
		return 'troubleshooting-manager-articles-archive';
	}

	public function get_title() {
		return esc_html__( 'Troubleshooting Articles Archive', 'troubleshooting-manager' );
	}
