...
if ( ! class_exists( 'Troubleshooting_Manager_Integration' ) ) {

	/**
	 * Define Troubleshooting_Manager_Integration class
	 */
	class Troubleshooting_Manager_Integration {
		...
		public function in_elementor() {
			 ...
			 * @var bool $result
			 */
			return apply_filters( 'troubleshooting-manager/in-elementor', $result );
		}
		...
		public function register_addons( $widgets_manager ) {
			...
			require troubleshooting_manager()->plugin_path( 'includes/base/class-troubleshooting-manager-base.php' );

			foreach ( glob( troubleshooting_manager()->plugin_path( 'includes/addons/' ) . '*.php' ) as $file ) {
		...
		public function register_category() {
			...
			$cherry_cat       = 'troubleshooting-manager';

			$elements_manager->add_category(
				$cherry_cat,
				array(
					'title' => esc_html__( 'Troubleshooting Manager', 'troubleshooting-manager' ),
					'icon'  => 'font',
				),
				1
			);
